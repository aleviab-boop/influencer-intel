      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 pt-16 pb-14 text-center">
            ...
            <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
              <Link href="/login?role=influencer" className="px-6 py-3 rounded-xl text-white text-[15px] font-semibold bg-ink-900 hover:bg-ink-800 transition-colors">Create your profile</Link>
              <Link href="#how-it-works" className="px-6 py-3 rounded-xl text-[15px] font-semibold border border-border hover:bg-[#faf9ff] transition-colors" style={{ color: ACCENT, borderColor: '#e3def9' }}>See how it works</Link>
            </div>
        ...
        <section className="max-w-5xl mx-auto px-6 pb-20">
          <div className="rounded-3xl px-8 py-14 text-center text-white" style={{ background: `linear-gradient(135deg, ${ACCENT}, #9b7bff)` }}>
            ...
            <Link href="/login?role=influencer" className="inline-block mt-7 px-7 py-3.5 rounded-xl bg-white text-[15px] font-semibold" style={{ color: ACCENT }}>Join free as a creator</Link>
          </div>
        </section>
      </main>
      <MarketingFooter />
