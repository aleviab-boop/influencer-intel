      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="mt-6 space-y-5">
            ...
            {/* Payout link */}
            <Link href={`/creator/payout${qs}`} className="flex items-center justify-between gap-3 rounded-2xl bg-white border border-border shadow-card px-5 py-4 hover:border-[#d9d4f5] transition-colors">
              <div className="flex items-center gap-3">
