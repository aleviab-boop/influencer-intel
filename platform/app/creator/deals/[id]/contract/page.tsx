    ...
    return (
      <div className="min-h-screen bg-[#f5f4f8] grid place-items-center px-6">
        <div className="max-w-md text-center rounded-2xl bg-white border border-border shadow-card p-8">
          ...
          <p className="mt-2 text-[13px] text-ink-500">We couldn&rsquo;t find this deal. It may have been removed.</p>
  ...
  return (
    <div className="min-h-screen bg-[#f5f4f8] py-8 px-4 font-sans">
      ...
      <p className="max-w-2xl mx-auto mt-3 text-center text-[11px] text-ink-300 print:hidden">
        A template agreement generated from your deal — review the terms and use “Save as PDF” to keep a copy. Not legal advice.
      </p>
    </div>
  );
}
