...
const ROW_A: Logo[] = [
  ...
  { name: 'OPPO', slug: 'oppo' },
  { name: 'Love Beauty and Planet', slug: 'lovebeautyplanet' },
...
const FEATURES = [
  ...
  { t: 'Competitor Analysis', d: 'Track creator overlaps and share of voice against your competitors.', href: '/brand-mentions', icon: 'database', color: '#EC4899', c2: '#FBCFE8', chip: 'Benchmark' },
